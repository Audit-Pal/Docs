...
## Introduction
AuditPal runs as a competitive subnet on the Bittensor network. The subnet coordinates miners, validators, and the scoring engine into a closed loop where performance is the only currency that matters.
