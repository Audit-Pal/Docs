...
This winner-takes-all structure is deliberate. It concentrates rewards on real improvements, not incremental tuning, and creates strong incentive to develop novel detection capabilities rather than copy existing approaches.
